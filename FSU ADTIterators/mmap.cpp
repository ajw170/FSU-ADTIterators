/*
    ...
    Dynamic Random Test of Map_ADT<String, int>
...
void WriteReport(fsu::Map_ADT<T,P> x, char n, unsigned long numreports);
...
int main(int argc, char* argv[])
{
  ...
  // objects
  fsu::Map_ADT<KeyType,DataType> x0, x1, x2;
  fsu::Map_ADT<KeyType,DataType>::Iterator i0, i1, i2, j, k;
  Random_class   ranobj;
  DataType       data;
  KeyType        key;
  size_t         loc = 0;
...
template < typename T , class P >
void WriteReport(fsu::Map_ADT<T,P> x, char n, unsigned long numrpts)
{
  size_t size = x.Size();
